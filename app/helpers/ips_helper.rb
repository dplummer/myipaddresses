module IpsHelper
  def text_fields_for_ipv4_address(model_name, ipv4_address)
    ...
    end.join(".\n") + " / " + text_field_tag("#{model_name}[prefix_v4]", ipv4_address.prefix, :maxlength => 2, :class => 'prefix_v4')
  end
  def text_fields_for_ipv6_address(model_name, ipv6_address)
    ...
    end.join(":\n") + " / " + text_field_tag("#{model_name}[prefix_v6]", ipv6_address.prefix, :maxlength => 3, :class => 'prefix_v6')
  end
end
